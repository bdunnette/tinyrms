...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseEvaluation.evaluation_date'
        db.add_column('eval_caseevaluation', 'evaluation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseEvaluation.evaluation_date'
        db.delete_column('eval_caseevaluation', 'evaluation_date')
